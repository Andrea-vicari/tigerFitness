...
function Agenda() {
    ...
    // Dark theme logics
  const color = useSelector((state) => state.counter.value)



  return (
    <div className='container'>
        <div className="dropdown-menu d-block position-static p-2 mx-0 shadow rounded-3 w-340px" data-bs-theme={color}>
        ...
        <div className="cal">
            ...
            <button className="btn cal-btn" disabled="" type="button">30</button>
            <button className="btn cal-btn" disabled="" type="button">31</button>
