  ...
  themeType == "ligth" ? textType = "" : textType = "text-bg-dark"
    ...
    const makeAPICall = async () => {
      ...
      const handleSubmit = async (e) =>{
        ...
        const response = await fetch(`https://tiger-fitness-server.vercel.app/api/workouts/${title}`, {
    ...
    return(
      <div className={'container-fluid' + " " + bgType}>
        <div className="container pt-5 mt-4">
            ...
            return(
              <div className="card border-none mb-3 rounded-3 pz-5 pz-sm-3 px-lg-1 border-0" key={e._id}>
