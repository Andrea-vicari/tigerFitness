...
import ListaPrenConfTrain from './ListaPrenConfTrain'
...
function PrenotazioniConfermate () {
  ...
  useEffect(() => {
    fetch('https://tiger-fitness-server.vercel.app/api/bookings/prenotazioni-approvate/')
    ...
    <>
      <div className='container-fluid pt-1 mt-5 bg-stripe d-none d-sm-block'>
        <div className='container text-center mt-5 pb-1'>
          <h1 className='display-2 text-white text-uppercase'>Prenotazioni confermate</h1>
        </div>
      </div>
        ...
        <div className="container-fluid mt-1 pt-0">
          <div className='table-responsive-lg mt-2'>
            <table className={"table table-striped table-hover" + " " + tableType}>
              ...
              <tbody>
                <ListaPrenConfTrain prenotazioni={currentPosts} loading={loading} />
              </tbody>
            </table>
